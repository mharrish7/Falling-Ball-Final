...
function moves() {
    ...
    if (speed2 > 0 && speed2> maxspeed) {
        speed2 = maxspeed;
    } else if (speed2 < 0 && speed2 < (-maxspeed)) {
        speed2 = -maxspeed;
    }
    ...
    var left2 = parseInt(window.getComputedStyle(ball2).getPropertyValue('left'));
    var top2 = parseInt(window.getComputedStyle(ball2).getPropertyValue('top'));
    ball2.style.left = left2 + speed2 + "px";
    ball2.style.top = top2 - jumps2 + "px";
...
function setplat() {
    ...
    if (r6 == 0 && spikelist.length == 0 && score >= 00) {
        console.log('h');
...
function check2(p) {
    ...
    if (parseInt(window.getComputedStyle(ball).getPropertyValue('top')) <= 10 || parseInt(window.getComputedStyle(ball).getPropertyValue('top')) >= 45 * 16 || parseInt(window.getComputedStyle(ball2).getPropertyValue('top')) <= 10 || parseInt(window.getComputedStyle(ball2).getPropertyValue('top')) >= 45 * 16) {
    ...
    else if (parseInt(window.getComputedStyle(ball).getPropertyValue('left')) + 2 * 16 <= parseInt(window.getComputedStyle(p).getPropertyValue('left'))) {
        console.log();
    }
    else if (parseInt(window.getComputedStyle(ball).getPropertyValue('top')) >= parseInt(window.getComputedStyle(p).getPropertyValue('top')) + 2 * 16) {
        console.log();
        
    }
    else if (parseInt(window.getComputedStyle(ball).getPropertyValue('top')) + 2 * 16 <= parseInt(window.getComputedStyle(p).getPropertyValue('top'))) {
        console.log();
    } else {
        jumps = j;
        current = p;
    }
    if (parseInt(window.getComputedStyle(ball2).getPropertyValue('left')) >= parseInt(window.getComputedStyle(p).getPropertyValue('left')) + 15 * 16) {
        console.log();
    }
    else if (parseInt(window.getComputedStyle(ball2).getPropertyValue('left')) + 2 * 16 <= parseInt(window.getComputedStyle(p).getPropertyValue('left'))) {
        console.log();
    }
    else if (parseInt(window.getComputedStyle(ball2).getPropertyValue('top')) >= parseInt(window.getComputedStyle(p).getPropertyValue('top')) + 2 * 16) {
        console.log();
    }
    else if (parseInt(window.getComputedStyle(ball2).getPropertyValue('top')) + 2 * 16 <= parseInt(window.getComputedStyle(p).getPropertyValue('top'))) {
        console.log();
    } else {
        jumps2 = j;
        current2 = p;
